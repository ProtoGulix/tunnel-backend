...
1. **[part_template.sql](../../02_ref/part_template.sql)** - Table des templates versionnés
2. **[part_template_field.sql](../../02_ref/part_template_field.sql)** - Table des champs de template
3. **[part_template_field_enum.sql](../../02_ref/part_template_field_enum.sql)** - Table des valeurs enum
4. **[stock_sub_family_template.sql](../../02_ref/stock_sub_family_template.sql)** - Ajout du lien template dans stock_sub_family

### 📁 Core transactionnel (01_core/)

5. **[stock_item_template.sql](../../01_core/stock_item_template.sql)** - Ajout du versionnement template dans stock_item
6. **[stock_item_characteristic.sql](../../01_core/stock_item_characteristic.sql)** - Table des valeurs de caractéristiques
