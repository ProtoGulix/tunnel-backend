...
| GET     | `/stock_items/{id}/with-characteristics` | Détail avec caractéristiques [v1.11.0] | [stock-items.md](docs/endpoints/stock-items.md) |
| GET     | `/stock_items/ref/{ref}`                 | Par référence                          | [stock-items.md](docs/endpoints/stock-items.md) |
| POST    | `/stock_items`                           | Créer (legacy ou template) [v1.11.0]   | [stock-items.md](docs/endpoints/stock-items.md) |
